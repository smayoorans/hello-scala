...
object AesCtrExample {
	...
	def testMain = {
	  val message = "Welcome to my blog"
	  val key =     "140b41b22a29beb4061bda66b6747e14"
	  val iv = "20814804c1767293bd9f1d9cab3bc3e7"


    println("message =========>" +message)
    println("hex =========>" +convertStringToHex(message))
    val encrypted = encrypt(iv, key, convertStringToHex(message))
    // val ciphertext = bytesToHex(encrypted)
     println(encrypted)

    //57656c636f6d6520746f206d7920626c6f672e204920686f70652074686973207475746f7269616c207761732068656c7066756c2e
